...
const Myactive = () => {
    ...
    const getBoardInfo = async () => {
        try {
            const response = await fetch('https://pflow.ddns.net/api/mypage/myboards', {
                method: "GET",
    ...
    const getCommentInfo = async () => {
        try {
            const response = await fetch('https://pflow.ddns.net/api/mypage/mycomment', {
                method: "GET",
                credentials: 'include', // 쿠키를 포함하여 요청
            });
    ...
    return (
        <div className="Myactive">
           ...
           {MyactiveTag === '나의게시물' ? <table className="myactive-tb">
                <thead>
                <tr>
                    <th className='header-th'>나의 게시물</th>
