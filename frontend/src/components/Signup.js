...
const Signup = () => {
    ...
    const id_check = async (e) =>{
        e.preventDefault();
        try{
            const response = await fetch("https://pflow.ddns.net/id_check", {
                method: "POST",
                headers: {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            const response = await fetch('https://pflow.ddns.net/api/signup', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const recode = async (e) => {
        ...
        try {
            const response = await fetch('https://pflow.ddns.net/api/recode', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
